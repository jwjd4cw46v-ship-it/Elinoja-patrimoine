...
export default function TechnicalAnalysisForm({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (error) {
      ...
      toast.success(
        analysis ? 'Analyse modifiée' :
        form.status === 'published' ? 'Analyse publiée ✓' : 'Brouillon sauvegardé'
      )
      onSaved()
      onClose()
    }
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              required rows={5} className="input-premium resize-none" />
          </div>
