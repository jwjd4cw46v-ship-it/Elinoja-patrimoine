...
export default function ClientHeader({ profile }: { profile: Profile }) {
  ...
  // Animation JS pure — translateX décrémenté chaque frame
  useEffect(() => {
  ...
  // Quadrupler pour scroll infini
  const tickerItems = sorted.length > 0
              ...
              {tickerItems.map((m, i) => {
                ...
                return (
                  <span
                    ...
                    <span style={{ fontSize: 12, fontFamily: 'monospace', fontWeight: 700, color: '#F5F5F5' }}>
                    ...
                    <span style={{ fontSize: 12, fontWeight: 500, color, display: 'inline-flex', alignItems: 'center', gap: 2 }}>
