...
async function getFromBase(today: string) {
...
async function getAgeSecondes(today: string) {
...
async function upsertMarkets(markets: any[], today: string) {
