...
// ── Detail Post ────────────────────────────────────────────
function PostDetailModal({ post, replies, replyText, submitting, isLiked, likedReplies, replyImage, replyAudio, replyingTo, userId, onReplyImageChange, onReplyAudioChange, onReplyingToChange, onReplyChange, onSubmitReply, onLike, onLikeReply, onShowLikers, onImageClick, onClose, onOpenProfile }: {
  post: ForumPost
  replies: ForumReply[]
  replyText: string
  submitting: boolean
