...
import { Plus, Search, TrendingUp, Edit, Trash2, Eye, RefreshCw } from 'lucide-react'
...
export default function AnalysesTechniquesPage() {
  ...
  function handleEdit(a: TechnicalAnalysis) {
    setEditing({ ...a })   // copie propre pour éviter mutation d'état
    setShowForm(true)
  }
  ...
  async function handleDelete(a: TechnicalAnalysis) {
    if (!confirm(`Supprimer l'analyse "${a.title}" ?\n\nCette action est irréversible.`)) return
    setDeleting(a.id)
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button onClick={fetchAnalyses} className="btn-ghost p-2.5">
            <RefreshCw size={14} />
          </button>
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="relative">
          ...
          <input value={search} onChange={e => setSearch(e.target.value)}
            placeholder="Ticker ou titre..." className="input-premium pl-9 w-56" />
        </div>
      ...
      <div className="card-premium overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <button onClick={handleNew} className="btn-gold mt-4">
                    ...
                    <motion.tr key={a.id}
                      ...
                      <td>
                        <div className="flex items-center gap-3">
                          {/* Image graphique si disponible */}
                          {(a as any).chart_image_url ? (
                            <img
                              src={(a as any).chart_image_url}
                              alt={a.ticker}
                          ...
                          <div>
                            <div className="font-medium text-sm line-clamp-1"
                              style={{ color: '#F5F5F5', maxWidth: 220 }}>
                              {a.title}
                            </div>
                            <div className="text-xs" style={{ color: '#5C5C5C' }}>
                              {a.ticker} · {a.market} · {a.timeframe}
                            </div>
                          </div>
                        </div>
                      </td>
