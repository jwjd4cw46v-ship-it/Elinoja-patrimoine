...
export async function sendNotification(p: NotifPayload): Promise<void> {
  ...
  // On le calcule ici plutôt que de se contenter d'incrémenter un compteur
  // local, pour rester toujours synchronisé avec l'état réel en base,
  // même si plusieurs notifications arrivent rapprochées ou hors-ordre.
